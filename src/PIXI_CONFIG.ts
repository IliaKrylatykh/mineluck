	...
	public getConfig() {
		return {
			...
			reel_B_container: {
				...
				x: () => gameConfig.gameWidth / 5,
				y: () => 0,
			},
			reel_C_container: {
				label: 'reel-C-container',
				x: () => (gameConfig.gameWidth / 5) * 2,
				y: () => 0,
			},
			reel_D_container: {
				label: 'reel-D-container',
				x: () => (gameConfig.gameWidth / 5) * 3,
				y: () => 0,
			},
			reel_E_container: {
				label: 'reel-E-container',
				x: () => (gameConfig.gameWidth / 5) * 4,
				y: () => 0,
			},
			animation_default: {
				...
				x: () => 0,
				y: () => 0,
				width: () => gameConfig.gameWidth / 5,
				height: () => gameConfig.gameWidth / 5,
				animationSpeed: 0.1,
				loop: true,
