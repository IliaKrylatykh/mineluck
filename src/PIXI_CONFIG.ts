	...
	public getConfig() {
		return {
			...
			master_reel_container: {
				label: 'master-reel-container',
				x: () => window.innerWidth / 2 - gameConfig.gameWidth / 2,
				y: () => window.innerHeight / 2 - gameConfig.gameWidth / 2 + 40,
			},
			...
			reel_B_container: {
				...
				x: () => gameConfig.gameWidth / 4,
				y: () => 0,
			},
			reel_C_container: {
				label: 'reel-C-container',
				x: () => (gameConfig.gameWidth / 4) * 2,
				y: () => 0,
			},
			reel_D_container: {
				label: 'reel-D-container',
				x: () => (gameConfig.gameWidth / 4) * 3,
				y: () => 0,
			},
			animation_default: {
				...
				x: () => 0,
				y: () => 0,
				width: () => gameConfig.gameWidth / 4,
				height: () => gameConfig.gameWidth / 4,
				animationSpeed: 0.1,
				loop: true,
