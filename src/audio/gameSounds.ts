...
function registerAll(sound: SoundModule): void {
	sound.add('UI-pick', assetUrl('assets/audio/SFX/BUTTON_12.wav'))
	sound.volume('UI-pick', 0.01)

	sound.add('music-1', assetUrl('assets/audio/music/main_theme.mp3'))
	sound.volume('music-1', 0.03)

	sound.add('reel-thud', assetUrl('assets/audio/SFX/light-thud-super-low.mp3'))
	sound.volume('reel-thud', 0.6)

	sound.add('coin-count-loop', assetUrl('assets/audio/SFX/coin-loop-detuned.wav'))
	sound.volume('coin-count-loop', 0.05)

	sound.add('coin-flung', assetUrl('assets/audio/SFX/coin-flung-med.mp3'))
